...
function nuevoLink() {
    var contenido = document.getElementById('contenido');
    var texto = document.getElementById("texto").value;
    var atribute = texto.split(' ');
    contenido.innerHTML = contenido.innerHTML + `<a href="${atribute[1]}" target="_blank">` + atribute[0] + '</a>';
}
function nuevoTitulo(){
    var contenido = document.getElementById('contenido');
    var texto = document.getElementById("texto").value;
    contenido.innerHTML = contenido.innerHTML + contenido.innerHTML + '<h1>' + texto + '</h1>';
}
